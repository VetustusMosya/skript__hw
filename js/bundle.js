...
function form(modalTimerId) {
	...
	function showThanksModal(message) {
		...
		(0,_popup__WEBPACK_IMPORTED_MODULE_0__.openModal)('.modal', modalTimerId);
		...
		setTimeout(() => {
			...
			(0,_popup__WEBPACK_IMPORTED_MODULE_0__.closeModal)('.modal');
		}, 4000);
	}
}
...
function popup(triggerSelector, modalSelector, modalTimerId) {
...
function slider() {
   ...
   `;
	...
	let replacePX = (string) => { return +string.replace(/\D/g, ''); };
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const modalTimerId = setTimeout(() => (0,_modules_popup__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimerId), 9999);

  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_6__["default"])();
  (0,_modules_popup__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-modal]', '.modal', modalTimerId);
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_0__["default"])();
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_2__["default"])();
  (0,_modules_form__WEBPACK_IMPORTED_MODULE_3__["default"])(modalTimerId);
